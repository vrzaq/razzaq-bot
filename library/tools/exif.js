...
require('dotenv').config();
    ...
    const { node_webpmux, fluent_ffmpeg, crypto, os, fs, chalk, path, child_process, yargs, util, baileysUtils, jimp, FileType } = new flatDirectly();
    const { tmpdir } = os;
...
async function writeExifImg (media, metadata) {
    ...
    if (metadata.packname || metadata.author) {
        const img = new node_webpmux.Image()
